...
function leerDirectorio_procesar(){
  ...
  /* const files = fs.readdirSync('./PRUEBAS PYTHON/convertidos/familiasContadores/')  */
...
async function procesarHost(familiaHost03,familiaHost12, contadores) {
  try { 
        ...
        const arregloFinalHost03 = [], arregloFinalHost12 = [];
        ...
        const rowsHost03  = await leerFilas(familiaHost03, {});//console.log("Filas:", rows[0][columns[4]]); //console.log(rows.length);
        const rowsHost12  = await leerFilas(familiaHost12, {});//console.log("Filas:", rows[0][columns[4]]); //console.log(rows.length);
...
/*********************************************** Escribe la salida en un nuevo archivo csv con sus contadores especificos ******************************************************/
        ...
        //path:  './PRUEBAS PYTHON/convertidos/unificados/'+nombreFamilia+'.csv',
